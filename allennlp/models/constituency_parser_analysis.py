...
class SpanConstituencyParserAnalysis(Model):
    ...
    def __init__(self,
        ...
        self.label_f1 = {label: F1Measure(index) for index, label in id_to_labels.items()}
    ...
    def forward(self,  # type: ignore
        ...
        if self._layer_index == "mixed":
            ...
            elmo_representations = elmo_output["layer_activations"][self._layer_index]
        ...
        if span_labels is not None:
            ...
            self.tag_accuracy(class_probabilities, span_labels, mask)
